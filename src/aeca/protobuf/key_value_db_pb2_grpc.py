...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in key_value_db_pb2_grpc.py depends on'
...
def add_KeyValueDBServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('aeca.rpc.db.kv.KeyValueDBService', rpc_method_handlers)
...
def add_KeyspaceManagerServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aeca.rpc.db.kv.KeyspaceManagerService', rpc_method_handlers)

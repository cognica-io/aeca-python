...
class SystemMetricsServiceStub(object):
...
class SystemMetricsServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SystemMetricsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'get_snapshot': grpc.unary_unary_rpc_method_handler(
                    servicer.get_snapshot,
                    request_deserializer=system__metrics__pb2.GetSystemMetricsSnapshotRequest.FromString,
                    response_serializer=system__metrics__pb2.GetSystemMetricsSnapshotResponse.SerializeToString,
            ),
    }
...
class SystemMetricsService(object):
    """Missing associated documentation comment in .proto file."""
